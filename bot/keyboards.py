...
# Имя команды кириллицей MAX принимает (проверено PATCH /me → GET /me), покупателю
# в меню виднее «связь», чем транслит. Обработчик всё равно ловит несколько написаний.
MAX_KOMANDA_SVYAZ = "связь"
...
# транслит на случай латинской раскладки и просто подпись словами.
_MAX_SVYAZ_VARIANTY = {
    f"/{MAX_KOMANDA_SVYAZ}", MAX_KOMANDA_SVYAZ, "/svyaz", "svyaz",
